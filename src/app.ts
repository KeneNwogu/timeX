...
const pageQuerySerializer = Joi.object().keys({ page: Joi.number().optional() })
...
app.get('/api/v1/staffs', auth('employer'), celebrate({ [Segments.QUERY]: pageQuerySerializer}), listStaff)
